...
export default () => (
    <Page page={""} navBack={true}>
        ...
        <p>The Website uses "cookies" to help personalize your online experience. A cookie is a text file
            ...
            <br/>
            Also learn more about our <Link href="/v2/cookies" passHref><a>cookie policy</a></Link>.
        ...
        <p>If you have any questions about this Policy, please <a onClick={openMail}>contact me</a>.</p>

        <p>This document was last updated on March 30, 2022</p>
        <style jsx>{`
          h1, h2, h3, h4, h5 {
            text-align: left;
          }
